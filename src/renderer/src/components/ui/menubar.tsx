...
>(({ className, ...props }, ref) => (
	<MenubarPrimitive.Root
		ref={ref}
		className={cn(
			'flex h-9 items-center space-x-1 border-zinc-200 bg-white p-1 shadow-sm dark:border-zinc-800 dark:bg-zinc-950',
			className
		)}
		{...props}
	/>
...
const MenubarShortcut = ({
	className,
	...props
}: React.HTMLAttributes<HTMLSpanElement>): JSX.Element => { return (
	<span
		className={cn(
